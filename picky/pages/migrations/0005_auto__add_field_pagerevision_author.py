...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageRevision.author'
        db.add_column('pages_pagerevision', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PageRevision.author'
        db.delete_column('pages_pagerevision', 'author_id')
